...
//        dao = new ProjectDAO((Session) getEm().getDelegate());
        SimpleClassIndexingStrategy<HProject>
                indexingStrategy =
                new SimpleClassIndexingStrategy<>(HProject.class);
//        indexingStrategy.invoke(new AsyncTaskHandle(),
//                org.hibernate.search.Search.getFullTextSession(getSession()));
    ...
    public void canDoFullTextSearch() throws Exception {
        ...
        indexingOptions.put(HProject.class,
                option);
        ...
        List<HProject> result =
                dao.searchProjects("samp", 10, 0, false);
//        Assertions.assertThat(result).hasSize(3);
        Assertions.assertThat(result).contains(expected);

        result =
                dao.searchProjects("sample-", 10, 0, false);
